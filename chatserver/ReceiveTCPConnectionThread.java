...
public class ReceiveTCPConnectionThread extends Thread {

    private final int tcpPort;
    private final Map<String, Chatroom> roomMap;
    private final Object roomMapLock;

    public ReceiveTCPConnectionThread(int tcpPort ,Map<String, Chatroom> roomMap, Object roomMapLock) {
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                CristiansLogger.writeMessageToLog("ready!");
                String clientMessage = in.readLine();

                CristiansLogger.writeMessageToLog("received client message");
